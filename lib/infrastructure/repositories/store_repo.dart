...
class StoreRepository {
  ...
  Future<Either<FailureModel, Unit>> createStore({required String storeName, required String address}) async {
    return _httpService.postData(CreateStoreParam(storeName: storeName, address: address));
  }
  ...
  Future<Either<FailureModel, PaginationResponse<StoreModel>>> getStores({int page = 1, int limit = 10}) async {
