...
String _$productNotifierHash() => r'624345aad6274fd0340bc64f078b8c5dae54ef6d';

/// See also [ProductNotifier].
@ProviderFor(ProductNotifier)
final productNotifierProvider = AutoDisposeAsyncNotifierProvider<
    ProductNotifier, PaginationResponse<ProductModel>>.internal(
  ProductNotifier.new,
...
typedef _$ProductNotifier
    = AutoDisposeAsyncNotifier<PaginationResponse<ProductModel>>;
